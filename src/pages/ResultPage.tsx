...
const ResultPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0B1120] text-gray-100 flex flex-col items-center justify-center px-6 py-10">
      <div className="max-w-3xl w-full bg-[#111827] p-10 rounded-2xl shadow-lg border border-gray-800 text-center">
        ...
        <p className="text-gray-400 mb-8">
          Has acertado{" "}
          <span className="text-white font-semibold">{correctCount}</span> de{" "}
        ...
        <button
          ...
          className="mt-10 px-6 py-3 bg-gradient-to-r from-indigo-500 to-cyan-400 text-white rounded-xl hover:opacity-90 transition-all"
        >
          Volver al inicio
        </button>
      </div>
